          ...
          _buildMenuCard(
            ...
            children: [
              ...
              _buildMenuTile(
                ...
                subtitle: "App and content languages",
                onTap: () => Navigator.push(
                  context,
          ...
          Card(
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Application Language", style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
                  const SizedBox(height: 12),
                  DropdownButtonFormField<String>(
                    initialValue: settings.appLanguage,
                    decoration: const InputDecoration(labelText: "UI Display Language"),
                    items: const [
                    ...
                    onChanged: (val) {
                      if (val != null) notifier.setAppLanguage(val);
                    },
                  ),
                ],
              ),
          ...
          Card(
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Content Localization", style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
                  const SizedBox(height: 12),
                  DropdownButtonFormField<String>(
                    initialValue: settings.contentLanguage,
                    decoration: const InputDecoration(labelText: "Anime & Manga Titles"),
                    items: const [
                      DropdownMenuItem(value: "en", child: Text("English (e.g. Demon Slayer)")),
                      DropdownMenuItem(value: "romaji", child: Text("Romaji (e.g. Kimetsu no Yaiba)")),
                      DropdownMenuItem(value: "native", child: Text("Native (e.g. 鬼滅の刃)")),
                    ],
                    onChanged: (val) {
                      if (val != null) notifier.setContentLanguage(val);
                    },
                  ),
                  const SizedBox(height: 16),
                  DropdownButtonFormField<String>(
                    initialValue: settings.preferredSubtitleLanguage,
                    decoration: const InputDecoration(labelText: "Subtitles Track"),
                    items: const [
                      DropdownMenuItem(value: "en", child: Text("English")),
                      DropdownMenuItem(value: "es", child: Text("Español")),
                      DropdownMenuItem(value: "fr", child: Text("Français")),
                    ...
                    onChanged: (val) {
                      if (val != null) notifier.setPreferredSubtitleLanguage(val);
                    },
                  ),
                  const SizedBox(height: 16),
                  DropdownButtonFormField<String>(
                    initialValue: settings.preferredAudioLanguage,
                    decoration: const InputDecoration(labelText: "Preferred Audio Voice"),
                    items: const [
                      DropdownMenuItem(value: "ja", child: Text("Japanese (Original)")),
                      DropdownMenuItem(value: "en", child: Text("English")),
                    ],
                    onChanged: (val) {
                      if (val != null) notifier.setPreferredAudioLanguage(val);
                    },
                  ),
                ],
              ),
          ...
          Card(
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Release Region", style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
                  const SizedBox(height: 12),
                  DropdownButtonFormField<String>(
                    ...
                    items: const [
                      ...
                      DropdownMenuItem(value: "JP", child: Text("Japan (JP)")),
